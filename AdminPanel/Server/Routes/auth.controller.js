...
router.delete('/user-delete/:id', async (req, res) => {
    try {
        ...
        return res.status(404).json({ success, error: "Successfully Deleted" })
    }
    catch (error) {
...
//         res.status(200).send("This is on progress")

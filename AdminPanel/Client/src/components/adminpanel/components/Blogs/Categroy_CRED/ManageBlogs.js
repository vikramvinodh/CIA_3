...
import { DeletBlog, DeletBlogCategory, fetchBlogCategory, Fetchblogs } from '../../functions';
...
function ManageBlogs() {
    ...
    /**
     * Fetch initally categories and show in the list 
     */
    useEffect(() => {
        const fetchData = async () => {
            const fetchedData = await fetchBlogCategory();
            setData(fetchedData);
        };
        fetchData();
        if (data) {
    ...
    async function handleFetchBlogs(id) {
        setId(id)
        const data = await Fetchblogs(id, numBlogs);
        setBlog(data);
    }
    ...
    return (
        <section className='manage-blogs container p-5 mt-5'>
            <h2 className='blog-heading'>Manage Blogs</h2>
            <div className='d-flex justify-content-around align-items-center'>
                ...
                <div className='blog-panel-category'>
                    ...
                    <div className='d-flex justify-content-between align-items-center p-3'>
                        <b>Category</b>
                        <button className='blog-panel-btn' onClick={() => navigate('../create-category')}>
                ...
                <div className='blog-panel-content blog-panel-category pt-0'>
                    <div className='d-flex justify-content-center align-items-center py-2'>
                        <button className='blog-panel-btn' onClick={() => navigate('../create-blog/category')}>
